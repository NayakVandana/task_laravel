                                ...
                                <div class="my-5">
                                    <div class="container mx-auto">
                                        ...
                                        <div class="flex justify-between items-center bg-gray-200 p-5 my-5 rounded-md">
                                            ...
                                            <div class="px-5 py-2 bg-green-500 rounded-md text-white text-lg shadow-md p-10 bg-red-50 dark:bg-red-800">
                                                <a href="{{ route('view') }}">View details</a>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                                                            ...
                                                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                                                ...
                                                                @if (session('data') && count(session('data')['TotalCasesCP']) > 0)
                                                                @foreach (session('data')['TotalCasesCP'] as $index => $item)
                                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                                    ...
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <img src="{{ $item['image'] }}" alt="Image" class="w-16 h-16 object-cover">
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        {{ $item['createdat'] }}
                                                                    </td>
